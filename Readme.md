...
## Description
This is a development board PCB made with a bare bones ESP32-C3. It can support wireless connections which is useful. It contanis three pin headers, with one containing power supply gpio. The other one is GPIO only and lastly the 2 pins are for TXD and RXD. Uses USB-C to get power. Boot switch and reset switch helps to activate anything using the chip. Chip enable can be connected via pins.
